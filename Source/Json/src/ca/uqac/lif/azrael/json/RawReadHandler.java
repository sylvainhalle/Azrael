...
public class RawReadHandler extends JsonReadHandler
{
	public RawReadHandler(JsonReader reader)
	{
		super(reader);
	}
	...
	@Override
	public Object handle(JsonElement o) throws ReadException 
	{
		return m_reader.unwrapContents(o);
	}
}
