 ...
 */
public class NullReadHandler extends XmlReadHandler
{	
	/**
	 * Creates a new Xml null reader
	 */
	public NullReadHandler(XmlReader reader)
	{
		super(reader);
	}
	...
	{
		return o instanceof TextElement && ((TextElement) o).getText().equals("null");
	}
	
	@Override
	public Object handle(XmlElement o) throws ReadException
	{
		if (!(o instanceof TextElement))
		{
			throw new ReadException("Expected a string");
		}
		String s = ((TextElement) o).getText();
		if (!s.equals("null"))
		{
			throw new ReadException("Expected 'null', got '" + s + "'");
		}
		return null;
	}
}
